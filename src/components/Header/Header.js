...
<div className="collapse navbar-collapse" id="navbarSupportedContent">
  ...
  <form className="  d-flex">
    <input value={searchValue} onChange={(event)=>cangeValueHandler(event)} className=" form-control  me-2" type="search" placeholder="поиск пользователя" aria-label="Search"/>
